          ...
          <v-row >
            <v-col>
                <v-list>
                  ...
                  <v-list-item><v-chip color="primary">
                    {{ s.pay === true ? "платим" : "волонтер" }}</v-chip></v-list-item>
                  <v-list-item>
            ...
            <v-col>
              <project-requests
              :skill="s" :project="project" @update-project="getProject()"></project-requests>
            </v-col>
          </v-row>
        </v-card>
...
<script>
import ProjectRequests from '~/components/projects/project/vacancies/projectRequests.vue';
