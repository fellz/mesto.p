  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          ...
          <nuxt-link
            ...
            to="/projects/auth/new"
            class="nav-link">Создать проект</nuxt-link></b>
        </li>
        <li class="nav-item">
          <b>
          <nuxt-link
            v-if="$store.state.authUser"
            to="/teams/auth/new"
            class="nav-link">Создать команду</nuxt-link></b>
        </li>
      </ul>
      <nuxt-link
        to="/register"
        v-if="!$store.state.authUser"
        class="nav-link">Регистрация</nuxt-link>
      <nuxt-link
        to="/login"
        v-if="!$store.state.authUser"
        class="nav-link">Войти</nuxt-link>
      <nuxt-link
        to="/loginprovider"
        v-if="!$store.state.authUser"
        class="nav-link">Войти Google</nuxt-link>
      <button
        type="button"
        class="btn btn-link"
        v-if="$store.state.authUser"
      ...
      <nuxt-link
        to="/my/auth/"
        v-if="$store.state.authUser"
        class="nav-link">{{ full_name }}</nuxt-link>
    </div>
  </nav>
</template>
